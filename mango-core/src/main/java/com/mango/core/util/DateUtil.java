...
public class DateUtil {
    ...
    public static final String FORMAT_DATETIME4 = "yyyyMMddHHmmssSSS";
    public static final String FORMAT_DATETIME5 = "yyyy-MM-dd HH:mm";
    public static final String FORMAT_DATETIME6 = "yyyyMMdd HH:mm";
    public static final String FORMAT_DATETIME7 = "yyyy-MM-dd 00:00:00";
    ...
    public static final String FORMAT_DATETIME_TIMEZONE = "yyyy-MM-dd'T'HH:mm:ss";
    ...
    static {
        ...
        dateTimeFormat = new SimpleDateFormat(FORMAT_DATETIME);
     ...
     * @return
     */
    public static Date getNowDateV1() {
    ...
    public static String getGMT8Str(String formatStr, Date date) {
    ...
    public static Date strToDate(String strTime) {
        ...
        list.add(FORMAT_DATETIME);
        list.add(FORMAT_DATETIME4);
        list.add(FORMAT_DATETIME5);
        list.add(FORMAT_DATETIME6);
        list.add(FORMAT_DATETIME2);
        list.add(FORMAT_DATE);
        // list.add(DATE_FORMAT_YY_MM_DD);
        list.add(FORMAT_DATE2);
        list.add(FORMAT_MONTH);
        list.add(FORMAT_MONTH2);
        list.add(FORMAT_YEAR);
    ...
    public static boolean validateIsDate(String strTime) {
        ...
        if (date != null) {
            System.out.println("生成的日期:" + DateUtil.parseDateToStr(date, DateUtil.FORMAT_DATETIME, "--null--"));
            return true;
        }
        return false;
    }
     ...
     */
    public static Date parseToUtcDate(String date, String format) throws ParseException {
        if (StringUtils.isNoneBlank(date) && StringUtils.isNoneBlank(format)) {
